...
% Las herramientas citadas se están utilizando de fo

% Se echa de menos un estado del arte que comente los usos didácticos que se le están dando a estas herramientas. Comentas que se la usan universidades, etc. pero cómo, qué resultados han obtenido, etc... Falta también discusión sobre el uso de este tipo de herramientas en enseñanzas medias...
